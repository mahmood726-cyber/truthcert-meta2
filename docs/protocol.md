        # Truthcert Meta2: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/truthcert-meta2.git

        ## Objective

        TruthCert Meta2 is the second generation of the TruthCert evidence certification framework, extending proof-carrying numbers to multi-arm and sequential meta-analyses.
        ...
        - Code: https://github.com/mahmood726-cyber/truthcert-meta2.git
        - Dashboard: https://mahmood726-cyber.github.io/truthcert-meta2/
